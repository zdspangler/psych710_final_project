...
## Analysis Append
Although we intended to use lmer, we found that the models we were trying to run were either too complex or too simple to provide generalizable results. To this end, we decided to run a bayesian analysis that allows us to answer our question much more succinctly. I've left the lmer models here just in case we want to address these shortcomings.
